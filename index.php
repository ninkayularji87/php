...
"dateFirst" => "Apr 2019",
"dateSecond" => "Current",
"description" => "Бегал за мышами",
],
[
"name" => "ООО Веселье",
"dateFirst" => "Jan 2016",
"dateSecond" => "Mar 2019",
"description" => "Гулял по дому",
],
[
"name" => "ООО Развлечение",
"dateFirst" => "Nov 2010",
"dateSecond" => "Dec 2015",
"description" => "Таскал еду со стола",
],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
         <h5 class="w3-opacity"><b><?php echo $experience[$i]["name"]; ?></b></h5>
          ...
          </i><?php echo $experience[$i]["dateFirst"]; ?> - 
          <?php if ($i == 0): ?>
           <span class="w3-tag w3-teal w3-round">
            <?php echo $experience[$i]["dateSecond"]; ?></span>
          <?php else: ?>
            <?php echo $experience[$i]["dateSecond"]; ?>
            <?php endif;?>
        </h6>
